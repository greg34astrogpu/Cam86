...
TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure reading_timeChange(Sender: TObject);
  private
...
// dt0:=GetTime(Hour,Min,Sec,HSec);
 ...
 if WriteFitsCol.Checked then
  begin
   st:= Edit1.Text+inttostr(nframe)+'col.fit';
   ff.FitFileCol(st);
   Memo1.Lines.Add('File '+st+' is recorded');
  end;
...
procedure TForm1.reading_timeChange(Sender: TObject);
begin
 //CameraReadingTime(reading_time.Position);
end;
